...
import movieImage1 from '../Asset/movie&uuid=09F1A3AD-C127-4C59-8AF5-DD949E8FD405.avif';
import movieImage2 from '../Asset/movie&uuid=09F1A3AD-C127-4C59-8AF5-DD949E8FD405.avif';
import movieImage3 from '../Asset/movie&uuid=09F1A3AD-C127-4C59-8AF5-DD949E8FD405.avif';
import movieImage4 from '../Asset/movie&uuid=09F1A3AD-C127-4C59-8AF5-DD949E8FD405.avif';
import backgroundImg from '../Asset/fabio-sasso-p9ymULoTPsw-unsplash.jpg'; // Assurez-vous de fournir le bon chemin vers votre image de fond
...
const Section = styled.div`
  position: relative;
  width: 100%;
  height: 60vh; /* Ajustez cette valeur pour réduire la hauteur de la section */
  background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(${props => props.$backgroundImage}) center/cover no-repeat;
  display: flex;
...
const Title = styled.h2`
  color: white;
  margin-bottom: 20px; /* Ajustez la marge pour remonter le titre */
  font-size: 2em;
  font-weight: 700;
