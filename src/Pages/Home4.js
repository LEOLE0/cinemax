    ...
    <div style={styles.container}>
      <div style={styles.contentSection}>
        ...
        <div style={styles.details}>
          ...
          <h1 style={styles.title}>BLUELOCK</h1>
          ...
          BLUELOCK, ancien soldat des Forces Spéciales, solitaire et paranoïaque,
        ...
        <div style={styles.videoContainer}>
          <video style={styles.video} controls>
            <source src="\Videos\BLUE LOCK NAGI video.mp4" type="video/mp4" />
